    ...
    <div class="row" style="height:80%">
        ...
        <div class="col-2" style="padding-left: 0;border-right: 1px solid">
            ...
            <div style="padding: 10% 15%">
                ...
                <div><a href="/letter/garbage">草稿箱</a></div>
                    ...
                    <c:if test="${not empty emailItems}">
                        ...
                        <div style="margin-top: 20px">
                            <form id="funForm" class="functionButton" action="/letter/manageGarbage" method="post">
                                <button type="button" class="btn btn-sm" onclick="manageEmail(1)">彻底删除</button>
                                <button type="button" class="btn btn-sm" onclick="manageEmail(2)">恢复</button>
